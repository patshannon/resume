export const projectData = [
  ...
  {
    title: "Alloprof",
    description: "Interactive math and vocabulary exercises for students, built with React and powered by Firestore and a headless CMS for content management.",
