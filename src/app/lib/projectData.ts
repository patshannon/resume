export const projectData = [
  ...
  {
    title: "Alloprof",
    description: "Interactive student exercises built with React, backed by Firestore and headless CMS (Squidex) content — reusable learning surfaces with data-backed exercise flows and maintainable content operations.",
  ...
  {
    title: "Captain's Log",
    description: "Automated dev journal that turns daily GitHub activity across every repo into a written narrative, running unattended every night via GitHub Actions. A provider-agnostic LLM pipeline with cost and safety discipline — including a no-activity fallback that emits a pre-written entry instead of hallucinating on sparse input.",
